...
export type Section = 'General' | 'Prerequisites' | 'Agents & Models' | 'Models' | 'Billing' | 'Gallery' | 'Autonomy & Budgets' | 'Connections' | 'Voice' | 'Memory & Knowledge';
const NAV_SECTIONS: Section[] = ['General', 'Prerequisites', 'Agents & Models', 'Models', 'Billing', 'Gallery', 'Autonomy & Budgets', 'Connections', 'Voice', 'Memory & Knowledge'];
            ...
            <>
              <div style={{ display: 'flex', flex: 1, overflow: 'hidden', minHeight: 0 }}>
                ...
                <div style={{
                  ...
                  {/* MODELS — multi-modal catalog (builtin + detected + custom) */}
                  {activeSection === 'Models' && <ModelsPanel />}

                  {/* BILLING — Ark/ByteDance subscription (read-only) */}
                  {activeSection === 'Billing' && <BillingPanel />}

                  {/* GALLERY — media generated by MCP tools */}
                  {activeSection === 'Gallery' && <MediaGallery />}
